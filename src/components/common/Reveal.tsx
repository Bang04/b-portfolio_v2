 ...
 * ---------------------------------------------------------------------------
 * 급경사지 프로젝트 섹션(Timeline · Featured Project · About)에만 쓴다.
 * 이 프로젝트가 "가장 오래 붙들고 설명할 것이
 * 가장 많다"고 스스로 적어둔 곳이라 스크롤이 특히 길다 — 애니메이션이 그
 * 길이를 지루하지 않게 끊어주는 역할을 하는 곳에만 넣고, 짧은 섹션에는
