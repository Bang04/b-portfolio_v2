...
const featuredProject: PortfolioData['featuredProject'] = {
  ...
  period: '2026.06 – 진행 중',
  domain: '재난안전 · 급경사지',
  team: '프론트엔드 — 급경사지 웹 도메인 단독 개발(모바일 웹뷰는 별도 담당) · 백엔드팀과 협업',
  ...
  role: {
    scope:
      '초기 기획·화면설계·데이터 명세서 작성 담당 후, 급경사지 실태조사 워크플로 개발부터 재해위험도 등급 산정 로직, 관리자 설정·데이터 로그 화면까지 급경사지 도메인 프론트엔드 전반을 담당. 실서버 API 105건의 연동 상태를 직접 실측해 문서로 관리했고(81.9% 연동), 계약이 어긋난 항목은 재현 증거를 첨부한 요청서로 백엔드팀과 협의',
  },
